...
const NavSidebar = () => {
  ...
  return (
    <nav className="w-full h-[50px]" ref={scope}
    >
      ...
      >
        ...
        <li className='navSidebar_ul_list'>
          ...
          <Link className=' navSidebar_ul_link' href={''}>실전 모의고사</Link>
          <Link className=' navSidebar_ul_link' href={''}>수준별 연습문제</Link>
          <Link className=' navSidebar_ul_link' href={''}>파트별 연습문제</Link>
          <Link className=' navSidebar_ul_link' href={''}>레벨 테스트</Link>

        </li>

        <li className='navSidebar_ul_list'>
          <p className=' navSidebar_ul_p'>커뮤니티</p>
          <Link className=' navSidebar_ul_link' href={''}>공지사항</Link>
          <Link className=' navSidebar_ul_link' href={''}>자유게시판</Link>
        </li>
